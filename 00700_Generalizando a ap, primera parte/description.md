Pheeew, costó implementar `codigoUnico`, ¿no?. Probablemente no querramos volver a desarrollar alguna operacion binaria entre `Validated`s desde cero. :astonished::gun:
